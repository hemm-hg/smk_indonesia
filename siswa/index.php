    ...
    <div class="main-wrapper">
        ...
        <main class="content">
            <div class="page-header">
                <div>
                    <h1>Data Siswa</h1>
                    <p class="subtitle">Kelola data siswa SMK Indonesia</p>
                </div>
                    ...
                    <div class="table-controls">
                        ...
                        <div class="table-search">
                            <form action="index.php" method="GET">
                                <label>Search:</label>
                                <input type="text" name="cari" placeholder="Cari NIS atau Nama..." value="<?php if (isset($_GET['cari'])) { echo $_GET['cari']; } ?>">
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="data-table">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>NIS <i class="fas fa-sort"></i></th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="edit.php?nis=<?php echo $row['nis']; ?>" class="btn-edit" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="proces/hapus.php?nis=<?php echo $row['nis']; ?>" class="btn-delete" title="Delete" onclick="return confirm('Yakin ingin menghapus data ini?')">
